...
(function(){
  ...
  var DICT={
    ja:{
      ...
      nav_construction:'🚧 工事中', nav_member:'会員<br>コンテンツ',
    ...
    en:{
      ...
      nav_construction:'🚧 Coming soon', nav_member:'Member<br>Contents',
    ...
    es:{
      ...
      nav_construction:'🚧 En construcción', nav_member:'Contenido<br>de socios',
