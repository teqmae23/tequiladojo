...
DATASETS = {
    ...
    "fabricas": {
        ...
        "columns": ["NOM", "Fabricas", "EstadoMunicipio", "Latitud", "Longitud"],
        "table": "fabricas",
        "keys": ["NOM"],
        "date_col": None,
    },
        ...
        "queries": [{
            "Query": {"Commands": [{"SemanticQueryDataShapeCommand": {
                "Query": {
                    ...
                    "Select": [
                        {"Column": {"Expression": {"SourceRef": {"Source": "v1"}}, "Property": "NOM"},
                         "Name": "v1.NOM", "NativeReferenceName": "NOM"},
                        {"Column": {"Expression": {"SourceRef": {"Source": "v1"}}, "Property": "Fabricas"},
                         "Name": "v1.Fabricas", "NativeReferenceName": "Fabricas"},
                        {"Column": {"Expression": {"SourceRef": {"Source": "v1"}}, "Property": "EstadoMunicipio"},
                         "Name": "v1.EstadoMunicipio", "NativeReferenceName": "EstadoMunicipio"},
